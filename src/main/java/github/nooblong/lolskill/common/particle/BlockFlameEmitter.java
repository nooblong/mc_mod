//package github.nooblong.lolskill.common.particle;
//
...
//{
//
//    @GameRegistry.ObjectHolder("lolskill:bfe")
//    public static final Item BFE = null;
//
//    @SubscribeEvent
//    public static void registerItems(RegistryEvent.Register<Item> event) {
//        event.getRegistry().register(new ItemBlock(new BlockFlameEmitter()).setRegistryName("bfe"));
//    }
//
//    @SubscribeEvent
//    public static void registerBlocks(RegistryEvent.Register<Block> event) {
//        event.getRegistry().register(new BlockFlameEmitter());
//    }
//
//    public BlockFlameEmitter()
//    {
//        super(Material.ROCK);
//        this.setCreativeTab(CreativeTab.skillTab);   // the block will appear on the Decorations tab in creative
//        setUnlocalizedName("bfe").setRegistryName("bfe");
//    }
//
