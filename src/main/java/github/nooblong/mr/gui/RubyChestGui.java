...
@OnlyIn(Dist.CLIENT)
public class RubyChestGui extends ContainerScreen<RubyChestContainer> {

    private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(
            MusicRestaurant.MOD_ID,"textures/gui/ruby_chest.png"
    );

    public RubyChestGui(RubyChestContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
